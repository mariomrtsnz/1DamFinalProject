...
function loadConfirmation() {
    ...
    if (
        ...
        $(".appointment-content").css({
            "grid-template-areas": '"date" "calendar" "time" "timePicker" "price" "finalPrice" "payNow" "payPhysically" "payLater"',
            "grid-template-rows": "0.1fr 0.5fr 0.1fr 0.5fr 0.1fr 0.5fr 0.2fr 0.2fr 0.2fr"
        });
    }
}